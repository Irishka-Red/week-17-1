...
const worker = new Worker('Ольга', 'Куприянова');
console.log(worker);
...
Worker.prototype.fullName = function () {
  ...
  const worker2 = new Worker("Ольга", "Куприянова");
...
const student = new Student ("Iryna", 17, 10);
console.log(student);
...
const student2 = new Student ("Iryna", 17, 10);
...
const book2 = new Book("Война и мир", "Толстой", 1865);
...
const account = new BankAccount1("13", 5000);
console.log(account);
...
const account2 = new BankAccount1("13", 5000);
...
const account3 = new BankAccount (5000, 6000);
account3.withdraw();
...
const animal = new Animal ("Рыжик","Мяу");
console.log(animal);
...
const animal2 = new Animal ("Зевс", "Гав");
animal2.makeSound();
...
const person= new Person ("Olga", 25, "Minsk");
console.log(person);
...
const person2 = new Person("Olga", 30, "Moscow");
...
const employee = new Employee("Alex", "worker", 5000);
...
const employee2 = new Employee("Alex", "worker", 5000);
...
const product = new Product("fish", 200, 5);
console.log(product);
...
const product2 = new Product("fish", 10, 5);
